      ...
      <IconButton LinkComponent={Link} to="/">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <FormLabel sx={labelStyle}>
            ...
            variant='standard' margin='normal' type='text' name='name'/>
            </>
          )
          }
            <FormLabel sx={labelStyle}>
            ...
            value={inputs.email}
            onChange={handleChange}
            variant='standard' margin='normal' type='email' name='email'/>
            <FormLabel sx={labelStyle}>
              Password
            </FormLabel>
            <TextField 
            ...
            onChange={handleChange}
            variant='standard' margin='normal' type='password' name='password'/>
